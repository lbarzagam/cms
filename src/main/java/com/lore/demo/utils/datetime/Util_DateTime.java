package com.lore.demo.utils.datetime;
...
public class Util_DateTime {
    ...
    public static LocalDateTime getServerLocalDateTimeFromChileanLocalDate(LocalDateTime localDateTime) {
        if (localDateTime == null)
            return null;
        ZonedDateTime zonedUTC = localDateTime.atZone(ZoneId.of("Chile/Continental"));
        ZonedDateTime zonedLocalServer = zonedUTC.withZoneSameInstant(ZoneId.of(TimeZone.getDefault().getID()));
    ...
    public static LocalDateTime deserializarFechaHora(String fechaHora, boolean horaRequerida) throws Exception {
        ...
        if (fecha == null)
            throw new Exception("ERROR_INTEGRIDAD_DATOS" + "Error parseando fecha: " + fechaHora);
    ...
    public static LocalDateTime deserializarFechaHoraSinTimeZone(String fechaHora, boolean horaRequerida) throws Exception {
        if (StringUtils.isBlank(fechaHora))
            return null;
        List<FormatoFechaHora> formatos = formatos();
    ...
    public static LocalDate deserializarFechaHoraAsLocalDate(String fechaHora) throws Exception {
        if (StringUtils.isBlank(fechaHora))
            return null;
        List<FormatoFechaHora> formatos = formatos();
    ...
    public static Date deserializarFechaHoraAsDate(String fechaHora, boolean horaRequerida) throws Exception {
