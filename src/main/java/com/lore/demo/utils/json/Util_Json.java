package com.lore.demo.utils.json;
...
public class Util_Json {
    ...
    public static String writeValueAsString(Object value) throws Exception {
        try {
          ...
          throw new Exception("ERROR_CONVIRTIENDO_OBJ_A_JSON");
        }
    }
    ...
    public static String writeValueAsStringWithoutIdentOutput(Object value) throws Exception {
        try {
